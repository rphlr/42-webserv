...
/*   Updated: 2024/02/27 18:17:01 by ckarl            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
string	&Server::getName(void) { return this->_server_name; }
int		&Server::getPort(void) { return this->_port; }
string	&Server::getHost(void) { return this->_host; }
int		&Server::getSize(void) { return this->_max_body_size; }
string	&Server::getRoot(void) { return this->_root; }
string	&Server::getDefFile(void) { return this->_default_file; }
